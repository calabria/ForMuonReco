...
process.STAMuonAnalyzer = cms.EDAnalyzer("STAMuonAnalyzer",
	...
	rootFileName = cms.untracked.string('GLBMuonAnalyzer.root'),
...
process.STAMuonAnalyzerWithGEMs = cms.EDAnalyzer("STAMuonAnalyzer",
	...
	MuonSeedCollectionLabel = cms.untracked.string('standAloneMuonSeeds'),
	rootFileName = cms.untracked.string('GLBMuonAnalyzerWithGEMs.root'),
...
process.p = cms.Path(process.globalMuons * process.STAMuonAnalyzerWithGEMs * process.STAMuonAnalyzer)
