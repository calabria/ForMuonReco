...
DQMAnalyzerSTEP1::DQMAnalyzerSTEP1(const edm::ParameterSet& iConfig)
{
   ...
   hPtResVsPt = dbe->book2D("PtResVsPt","p_{T} Resolution vs. Sim p_{T}",261,-2.5,1302.5,400,-2,2);
   hInvPtResVsPt = dbe->book2D("InvPtResVsPt","1/p_{T} Resolution vs. Sim p_{T}",261,-2.5,1302.5,400,-2,2);
   hPtResVsEta = dbe->book2D("PtResVsEta","p_{T} Resolution vs. Sim #eta",100,-2.5,2.5,400,-2,2);
   hInvPtResVsEta = dbe->book2D("InvPtResVsEta","1/p_{T} Resolution vs. Sim #eta",100,-2.5,2.5,400,-2,2);
