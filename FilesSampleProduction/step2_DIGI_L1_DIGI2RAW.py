...
# with command line options: step2 -s DIGI,L1,DIGI2RAW --conditions auto:upgrade2019 --geometry Extended2019 --datatier GEN-SIM-DIGI-RAW -n 10 --eventcontent FEVTDEBUGHLT --customise SLHCUpgradeSimulations/Configuration/combinedCustoms.cust_2019,SLHCUpgradeSimulations/Configuration/customise_mixing.customise_NoCrossing --filein file:step12019.root --fileout file:step22019.root
...
process.source = cms.Source("PoolSource",
    ...
    fileNames = cms.untracked.vstring('file:step_1.root')
)
...
process.FEVTDEBUGHLToutput = cms.OutputModule("PoolOutputModule",
    ...
    fileName = cms.untracked.string('file:step_2_1.root'),
